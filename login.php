		...
		<div class="card">
			...
			<div class="content">
				<div class="header">
                    ...
                    <button id="signup" class="signupbtn" name="signup"><a href="signup.php" style="text-decoration:none; color:black;">Sign up</a></button><br><br>
